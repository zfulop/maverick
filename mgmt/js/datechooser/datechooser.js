...
function showChooser(obj, inputId, divId, start, end, format, isTimeChooser, relativePosition) {
        ...
        if (input !== undefined && div !== undefined) {
            if (input.DateChooser === undefined) {
				...
				if(relativePosition !== undefined) {
					input.DateChooser.setRelativePosition(document.getElementById(relativePosition));
				}
            }
...
DateChooser.prototype.setRelativePosition = function(element) {
	this._relativePosition = element;
}
...
DateChooser.prototype.show = function() {
    ...
    var inputPos = getAbsolutePosition(this._relativePosition);
    this._div.style.top = (inputPos[0] + this._relativePosition.offsetHeight) + "px";
    this._div.style.left = (inputPos[1] + this._relativePosition.offsetWidth) + "px";
