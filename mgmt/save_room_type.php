...
if($id < 1) {
	$sql = "INSERT INTO room_types (name, type, num_of_beds, num_of_extra_beds, price_per_room, price_per_bed, _order) VALUES ('$name', '$type', $numOfBeds, $numOfExtraBeds, $pricePerRoom, $pricePerBed, $order)";
} else {
	$sql = "UPDATE room_types SET name='$name', type='$type', num_of_beds=$numOfBeds, num_of_extra_beds=$numOfExtraBeds, price_per_room=$pricePerRoom, price_per_bed=$pricePerBed, _order=$order WHERE id=$id";
}
