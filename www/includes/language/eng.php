...
define('ABOUT_HOSTEL_DESCRIPTION', 'Maverick Hostel is in the center of Budapest inside a historical Hapsburg building from 1905. It has almost every comfort of a hotel and all the charm of a hostel:  smaller than City Lodge, it has homely atmosphere. Both private rooms and dorms with historical style are available for a comfortable stay. Please step inside...');
...
define('AIRPORT_TO_HOSTEL', '- Take bus 200E, Reptéri busz, to Kôbánya Kispest, then take the subway 3(blue) to Ferenciek tere.<br>As you come up from the subway, take the stairs on your left (exit C). At the top of the stairs go straight, and by leaving the CBA (grocery store) on the left, walk towards the river (you will see a big sign for Maverick on the buliding at the corner). Our entrance is between a change office and Lipóti Pékség (pastry shop).<br>- Airport pick up is also available.');
...
define('CAROUSEL_HOME_1_TITLE', 'Entry Hall<br><span>Hostel</span>');
define('CAROUSEL_HOME_2_TITLE', 'Building Exterior<br><span>City Lodge</span>');
define('CAROUSEL_HOME_3_TITLE', 'Lobby<br><span>City Lodge</span>');
define('CAROUSEL_HOME_4_TITLE', 'Lobby<br><span>City Lodge</span>');
define('CAROUSEL_HOME_5_TITLE', 'Lobby<span>Hostel</span>');
define('CAROUSEL_HOME_6_TITLE', 'Double room with private bathroom<br><span>City Lodge</span>');
define('CAROUSEL_HOME_7_TITLE', '6 bed Dorm<br><span>City Lodge</span>');
define('CAROUSEL_HOME_8_TITLE', 'Double room with private bathroom<br><span>City Lodge</span>');
define('CAROUSEL_HOME_9_TITLE', 'Common Kitchen<br><span>Hostel</span>');
define('CAROUSEL_HOME_10_TITLE', 'Double room with private bathroom<br><span>Hostel</span>');
define('CAROUSEL_HOME_11_TITLE', '10 bed dorm with private bathroom<br><span>Hostel</span>');
define('CAROUSEL_HOSTEL_1_TITLE', 'Entry Hall<br><span>Hostel</span>');
define('CAROUSEL_HOSTEL_2_TITLE', 'Lobby<br><span>Hostel</span>');
define('CAROUSEL_HOSTEL_3_TITLE', 'Common Kitchen<br><span>Hostel</span>');
define('CAROUSEL_HOSTEL_4_TITLE', 'Double room with private bathroom<br><span>Hostel</span>');
define('CAROUSEL_HOSTEL_5_TITLE', 'Double room with shared bathroom<br><span>Hostel</span>');
define('CAROUSEL_HOSTEL_6_TITLE', '10 bed dorm with private bathroom<br><span>Hostel</span>');
define('CAROUSEL_HOSTEL_7_TITLE', '5 bed dorm<br><span>Hostel</span>');
define('CAROUSEL_HOSTEL_8_TITLE', '5 bed room with own bathroom<br><span>Hostel</span>');
define('CAROUSEL_HOSTEL_9_TITLE', 'Triple room with own bathroom<br><span>Hostel</span>');
define('CAROUSEL_HOSTEL_10_TITLE', 'Staircase<br><span>Hostel</span>');
define('CAROUSEL_LODGE_1_TITLE', 'Building exterior<br><span>City Lodge</span>');
define('CAROUSEL_LODGE_2_TITLE', 'Lobby<br><span>City Lodge</span>');
define('CAROUSEL_LODGE_3_TITLE', 'Lobby<br><span>City Lodge</span>');
define('CAROUSEL_LODGE_4_TITLE', 'Double room with private bathroom<br><span>City Lodge</span>');
define('CAROUSEL_LODGE_5_TITLE', 'Double room with private bathroom<br><span>City Lodge</span>');
define('CAROUSEL_LODGE_6_TITLE', '8 bed Dorm<br><span>City Lodge</span>');
define('CAROUSEL_LODGE_7_TITLE', '6 bed dorm<br><span>City Lodge</span>');
define('CAROUSEL_LODGE_8_TITLE', '6 bed dorm<br><span>City Lodge</span>');
...
define('CAROUSEL_LODGE_11_TITLE', 'Common Kitchen<span>City Lodge</span>');
define('CAROUSEL_LODGE_12_TITLE', 'Kazinczy street');
define('CHANGE_DATES', 'Change dates');
define('CHECK_AVAILABILITY', 'Check availability');
define('CHECKIN', 'Check-in');
define('CHECKIN_DATE', 'Check-in Date');
define('CHECKIN_TIME_INFO', 'Please note that the official check in time is after 3 pm, but you can arrive earlier and leave your luggage here.');
...
define('HOSTEL_DESCRIPTION_HOME', 'The Hostel is in the center of Budapest, in a palatial old building dating back to the Hapsburg era. We offer both private rooms with up to 5 beds and the dorms without bunk beds. Rooms combine modern design and historical style.');
define('HOW_TO_GET_HERE', 'How to get here?');
...
define('INTERNATIONAL_BUS_STATION_TO_HOSTEL', '- Take subway 3(blue) to Ferenciek tere. As you come up from the subway, take the stairs on your left (exit C). At the top of the stairs go straight, and by leaving the CBA (grocery store) on the left, walk towards the river (you will see a big sign for Maverick on the buliding at the corner). Our entrance is between a change office and Lipóti Pékség (pastry shop).');
...
define('LODGE_DESCRIPTION_HOME', 'Our newly built City Lodge is in the heart of the historical Jewish Quarter of the city center of Budapest. The City Lodge has various hotel quality private rooms with full private bathrooms, and we offer the utmost in privacy and comfort to our dorm guests as well.');
define('MARCH', 'March');
define('MAY', 'May');
define('MORE', 'more');
...
define('POLICY_HOSTEL_2', 'Check out is 11 AM. We can store your luggage longer if needed.');
define('POLICY_HOSTEL_3', 'By that time, please empty the locker and leave the bed or private room.');
...
define('POLICY_HOSTEL_7', 'For the serenity of our neighbours we kindly ask you to <u>keep quiet</u> in the building of the hostel.');
...
define('POLICY_HOSTEL_15', 'By signing our registration card you accept the policy of the Maverick Hostel and you take fullresponsibility for all of your actions inside the building.');
...
define('POLICY_LODGE_2', 'Check out is 11 AM. We can store your luggage longer if needed. ');
define('POLICY_LODGE_3', 'By that time, please empty the locker and leave the bed or private room.');
...
define('POLICY_LODGE_15', 'For the serenity of other guests we kindly ask you to <u>keep a normal talking tone of voice</u> in the building of the Lodge.');
define('POLICY_LODGE_16', '<u>It is not allowed to enter the back courtyard through the hostel</u>. Using fire exit without case of emergency would lead to a fine of 200 Euros and any further damage in the courtyard or neighboring buildings will be your own responsibility.I');
...
define('POLICY_LODGE_26', 'Beside the fines and sanctions described above, anyone who is heavily violating this Policy will be immediate checked out, and will be required to leave the Lodge.');
define('POLICY_LODGE_27', 'Beside the fines and sanctions described herein, if the Lodge notices any illegal activity, or any activity that requires official actions, it shall be entitled to inform the relevant authorities, offices, including especially the police.');
define('PRICE', 'Price');
define('PRICE_PER_NIGHT_PER_BED', '%s/night/bed');
define('PRICE_PER_NIGHT_PER_ROOM', '%s/night/room');
define('PRICE_PER_OCCASION', '%s/%s');
define('PRICE_STARTING_FROM_PER_BED', 'From %s/bed');
define('PRICE_STARTING_FROM_PER_ROOM', 'From %s/room');
...
define('RAILWAY_STATIONS_TO_HOSTEL', '<b>Keleti - 10min.</b><br>- Take bus 5, 7, 7A, 8, 112 or 178 till Ferenciek tere. After you got off the bus, go backwards to the metro’s underpath and cross the road (Kossuth Lajos utca). Come up from the underpath taking the right stairs (exit C) and walk straight 50 meters, passing the CBA (grocery store) on the left. Our entrance is the big green gate, situated between the Lipóti Pékség (pastry shop) and the exchange office.<br>OR<br>- Take the subway line 2(red) to Deák tér, then change to the line 3(blue) to Ferenciek tere. As you come up from the subway, take the stairs on your left (exit C). At the top of the stairs go straight, and by leaving the CBA (grocery store) on the left, walk towards the river (you will see a big sign for Maverick on the buliding at the corner). Our entrance is between a change office and Lipóti Pékség (pastry shop).<br><br><b>Nyugati - 5min.</b><br>- Take the subway line 3(blue) to Ferenciek tere.<br>- As you come up from the subway, take the stairs on your left (exit C). At the top of the stairs go straight, and by leaving the CBA (grocery store) on the left, walk towards the river (you will see a big sign for Maverick on the buliding at the corner). Our entrance is between a change office and Lipóti Pékség (pastry shop).<br><br><b>Déli - 10min.</b><br>- Get on the subway line 2(red) to Deák tér, then change to line 3(blue) to Ferenciek tere.<br>- As you come up from the subway, take the stairs on your left (exit C). At the top of the stairs go straight, and by leaving the CBA (grocery store) on the left, walk towards the river (you will see a big sign for Maverick on the buliding at the corner). Our entrance is between a change office and Lipóti Pékség (pastry shop).');
