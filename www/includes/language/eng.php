...
define('ABOUT_APARTMENTS_DESCRIPTION', 'The <b>Best Deal</b> is only available if you book here at the Maverick website:<br><br><b>·         No deposit<br>·         No booking fee<br>·         All taxes (VAT, City tax) included<br>·         Late check out (till 12 o’clock)</b><br><br>Read more below...');
define('ABOUT_APARTMENTS_DESCRIPTION_EXTRA', 'Book any of our 7 separate apartments and enjoy the same high level of comfort and amenities. Total privacy is guaranteed, but as an added benefit you will also have 24-hour access to Maverick Hostel\'s useful reception desk services. Apartment range is from 20 m2 for 2 guests to 80 m2 for up to 6 people.<br><br>Six of the apartments are in the same historical royal mansion that is also home to Maverick Hostel, while one apartment is just a 3-minute-walk away in another historical building. This separate apartment overlooks the Danube river and offers a truly amazing panorama of the Buda side across the water.<br><br>The location is as central as it gets, and the neighborhood is home to charming little streets dating back to the Middle Ages, yet feature a number of places offering modern dining, shopping, culture, and entertainment. While our location is well served by public transport, it also lets you get to most standard city attractions by just a casual walk.<br><br>All apartments feature elevator access, a fully equipped kitchen, free WiFi, free tea and coffee, free cable TV, and an elegant full bathroom with hairdryer. Linen and towels are also included. Some apartments have a washing machine, others offer laundry service.<br><br>Take a look around, see which apartment you like, and come say hello to other guests at our complementary social event if you had enough of all your privacy.<br><br>Looking forward to seeing you at Maverick Apartments.<br>');
define('ABOUT_HOSTEL', 'About Maverick Hostel');
define('ABOUT_HOSTEL_DESCRIPTION', 'The <b>Best Deal</b> is only available if you book here at the Maverick website:<br><br><b>·         No deposit<br>·         No booking fee<br>·         All taxes (VAT, City tax) included<br>·         Late check out (till 12 o’clock)</b><br><br><br>Read more below...');
define('ABOUT_HOSTEL_DESCRIPTION_EXTRA', 'Would you like to feel the pulse of Budapest while enjoying a relaxing and clean environment with a friendly atmosphere? The Maverick Hostel is always a nice haven to return to after a busy day in the city.<br><br>Located in the heart of the city in a renovated royal mansion built by the Hapsburg dynasty, the Maverick Hostel is open to guests in its original magnificence. We offer both private rooms with up to 5 beds and the dorms without bunk beds. Rooms combine modern design and historical style. The area is home to many small streets originating in the Middle Ages, now offering a variety of culture, great restaurants, traditional coffee houses, bars. Most of the city\'s tourist attractions  are within 15 minutes on foot, including the Castle area on the Buda side and the famous ruin pubs too.<br><br>Our Best Features:<br>•	Perfect Location, Smoke Free environment.<br>•	Free Wifi and Internet in the entire building.<br>•	Common areas and fully equipped kitchens.<br>•	24 hour reception with helpful multilingual staff.<br>•	Free Tea and Coffee all day long.<br>•	Daily cleaning for all roomtypes.<br>•	Linen and towel also included in the price.<br>•	High quality private rooms with nice own bathroom and cable Tv.<br>•	No bunkbeds in dorms, but reading lights and Free lockers.<br>•	Super market in the building and 24 hour grocery store next door.<br>•	Social Events every day where you can taste special Hungarian beverages for Free.<br><br>See you at the Maverick! ');
define('ABOUT_LODGE', 'About Maverick City Lodge');
define('ABOUT_LODGE_DESCRIPTION', 'The <b>Best Deal</b> is only available if you book here at the Maverick website:<br><br><b>·         No deposit<br>·         No booking fee<br>·         All taxes (VAT, City tax) included<br>·         Late check out (till 12 o’clock)</b><br><br>Read more below...');
define('ABOUT_LODGE_DESCRIPTION_EXTRA', 'Our newly built City Lodge is in the heart of the historical Jewish Quarter of the city center of Budapest. Most city attractions  are in walking distance, and the wonderfully eclectic streets in our neighborhood are dotted with lots of restaurants featuring local and international cuisine, concert venues, the Opera House, modern bars, and ruined pubs: all with their unique characters to explore.<br><br>Why stay with us?<br><br>Location<br>•	Most city attractions in walking distance.<br>•	24 hour super market next door.<br><br>Rooms<br>•	Hotel-quality double, triple and 4-bed rooms  with private bathrooms, modern style, flat screen Tv and custom-made designer furniture.<br>•	All dorms have designed cozy sleeping compartments with drape curtains, reading lamps and free lockers. <br>•	All rooms are air conditioned.<br>•	Linen and Towel also included in the price.<br><br>Facilities and services<br>•	We provide several Internet-connected computers, and WiFi – all for free unlimited use.<br>•	Large Common areas, fully equiped kitchen and smoke free environment.<br>•	24 hour reception and helpful multilingual staff.<br>•	Daily cleaning for all rooms.<br>•	Free Tea and Coffee all day long.<br>•	A nice thing about traveling is meeting new people, so we try to help our guests socialize during our daily free-of-charge community events, where we also offer free drinks.<br><br>We hope you’ll find the ideal room at Maverick City Lodge and we’ll see you soon. <br><br><br><br>');
...
define('ADDRESS_VALUE_APARTMENTS', 'Hungary, Budapest 1051, <br>Ferenciek tere 2 and Belgrad rakpart 27.');
define('ADDRESS_VALUE_APARTMENTS_GENERAL', 'Maverick <strong>Apartments</strong> <em>Budapest, Ferenciek tere 2 and Belgrad rakpart 27</em>');
...
define('AIRPORT_TO_APARTMENTS', '- Take bus 200E, Reptéri busz, to Kôbánya Kispest, then take the subway 3(blue) to Ferenciek tere.<br>As you come up from the subway, take the stairs on your left (exit C). At the top of the stairs go straight for 50 meters. Our entrance a big green gate will be on the left, next to an change office right behind the bus stop.<br>- Airport pick up is also available.');
define('AIRPORT_TO_APARTMENTS_2', 'Airport pick up is also available. (Address: Ferenciek tere 2.)');
...
define('CAROUSEL_APARTMENTS_1_TITLE', 'View, Deluxe One-Bedroom');
...
define('CAROUSEL_APARTMENTS_3_TITLE', 'Deluxe Two-Bedroom');
define('CAROUSEL_APARTMENTS_3_TITLE_BIG', 'Apartment');
define('CAROUSEL_APARTMENTS_4_TITLE', 'Deluxe Two-Bedroom');
define('CAROUSEL_APARTMENTS_4_TITLE_BIG', 'Apartment');
define('CAROUSEL_APARTMENTS_5_TITLE', 'Deluxe One-Bedroom');
define('CAROUSEL_APARTMENTS_5_TITLE_BIG', 'Apartment');
define('CAROUSEL_APARTMENTS_6_TITLE', 'Deluxe One-Bedroom');
define('CAROUSEL_APARTMENTS_6_TITLE_BIG', 'Apartment');
define('CAROUSEL_APARTMENTS_7_TITLE', 'One-Bedroom');
define('CAROUSEL_APARTMENTS_7_TITLE_BIG', 'Apartment');
define('CAROUSEL_APARTMENTS_8_TITLE', 'One-Bedroom');
...
define('CAROUSEL_APARTMENTS_12_TITLE', 'Building, Deluxe One-Bedroom');
...
define('CAROUSEL_HOME_2_TITLE', 'Entry Hall');
define('CAROUSEL_HOME_2_TITLE_BIG', 'Hostel & Apartments');
define('CAROUSEL_HOME_3_TITLE', 'One-bedroom');
...
define('CAROUSEL_HOME_6_TITLE', 'Double room with bathroom');
define('CAROUSEL_HOME_6_TITLE_BIG', 'City Lodge');
define('CAROUSEL_HOME_7_TITLE', 'Deluxe Two-Bedroom');
define('CAROUSEL_HOME_7_TITLE_BIG', 'Apartment');
define('CAROUSEL_HOME_8_TITLE', '6 bed dorm');
define('CAROUSEL_HOME_8_TITLE_BIG', 'City Lodge');
define('CAROUSEL_HOME_9_TITLE', 'Double room with bathroom');
define('CAROUSEL_HOME_9_TITLE_BIG', 'Hostel');
define('CAROUSEL_HOME_10_TITLE', '10 bed dorm');
define('CAROUSEL_HOME_10_TITLE_BIG', 'Hostel');
define('CAROUSEL_HOME_11_TITLE', 'Lobby');
define('CAROUSEL_HOME_11_TITLE_BIG', 'City Lodge');
define('CAROUSEL_HOME_12_TITLE', 'Deluxe One-bedroom');
define('CAROUSEL_HOME_12_TITLE_BIG', 'Apartment');
define('CAROUSEL_HOME_13_TITLE', 'Common kitchen');
define('CAROUSEL_HOME_13_TITLE_BIG', 'Hostel');
define('CAROUSEL_HOME_14_TITLE', 'Building Exterior');
define('CAROUSEL_HOME_14_TITLE_BIG', 'City Lodge');
define('CAROUSEL_HOSTEL_1_TITLE', 'Entry Hall');
define('CAROUSEL_HOSTEL_1_TITLE_BIG', 'Hostel');
define('CAROUSEL_HOSTEL_2_TITLE', 'Lobby');
define('CAROUSEL_HOSTEL_2_TITLE_BIG', 'Hostel');
define('CAROUSEL_HOSTEL_3_TITLE', 'Double room with bathroom');
define('CAROUSEL_HOSTEL_3_TITLE_BIG', 'Hostel');
define('CAROUSEL_HOSTEL_4_TITLE', '5 bed dorm');
define('CAROUSEL_HOSTEL_4_TITLE_BIG', 'Hostel');
define('CAROUSEL_HOSTEL_5_TITLE', 'Double room with bathroom');
define('CAROUSEL_HOSTEL_5_TITLE_BIG', 'Hostel');
define('CAROUSEL_HOSTEL_6_TITLE', '10 bed dorm');
define('CAROUSEL_HOSTEL_6_TITLE_BIG', 'Hostel');
define('CAROUSEL_HOSTEL_7_TITLE', '5 bed room with bathroom');
define('CAROUSEL_HOSTEL_7_TITLE_BIG', 'Hostel');
define('CAROUSEL_HOSTEL_8_TITLE', 'Triple room with bathroom');
define('CAROUSEL_HOSTEL_8_TITLE_BIG', 'Hostel');
define('CAROUSEL_HOSTEL_9_TITLE', 'Common Kitchen');
define('CAROUSEL_HOSTEL_9_TITLE_BIG', 'Hostel');
define('CAROUSEL_HOSTEL_10_TITLE', 'Staircase');
...
define('CAROUSEL_LODGE_3_TITLE', 'Double room with bathroom');
define('CAROUSEL_LODGE_3_TITLE_BIG', 'City Lodge');
define('CAROUSEL_LODGE_4_TITLE', 'Double room with bathroom');
define('CAROUSEL_LODGE_4_TITLE_BIG', 'City Lodge');
define('CAROUSEL_LODGE_5_TITLE', '8 bed dorm');
define('CAROUSEL_LODGE_5_TITLE_BIG', 'City Lodge');
define('CAROUSEL_LODGE_6_TITLE', '6 bed Dorm');
define('CAROUSEL_LODGE_6_TITLE_BIG', 'City Lodge');
define('CAROUSEL_LODGE_7_TITLE', '6 bed dorm');
...
define('CAROUSEL_LODGE_9_TITLE', 'Double room with shared bathroom');
define('CAROUSEL_LODGE_9_TITLE_BIG', 'City Lodge');
define('CAROUSEL_LODGE_10_TITLE', 'Common Kitchen');
define('CAROUSEL_LODGE_10_TITLE_BIG', 'City Lodge');
define('CAROUSEL_LODGE_11_TITLE', 'Building Exterior');
...
define('CHECK_AVAILABILITY', 'Check rates and availability ');
...
define('CHOOSE_MAVERICK_TO_CONTACT', 'Select a Maverick');
...
define('DIRECTIONS', 'Address and directions');
define('DIRECTIONS_TO_APARTMENTS', 'Directions to Maverick Apartments');
...
define('GET_IN_TOUCH', 'Contact us');
define('GET_IN_TOUCH_EXPLAIN', 'Please fill out the form below if you have any request or question and we will get back to you within 24 hours.<br><br>Thank you for contacting us and we hope to see you soon at the Maverick.');
...
define('INTERNATIONAL_BUS_STATION_TO_APARTMENTS', '- Take subway 3(blue) to Ferenciek tere. As you come up from the subway, take the stairs on your left (exit C). At the top of the stairs go straight for 50 meters. Our entrance a big green gate will be on the left, next to an change office right behind the bus stop.');
...
define('POLICY_APARTMENTS_5', 'A security deposit of EUR 100 is required upon arrival for incidentals. This deposit is fully refundable upon check-out and subject to a damage inspection of the accommodation.');
...
define('PRICE', 'Price');
define('PRICE_PER_NIGHT_PER_2_GUESTS', '%s/night/2 guests');
...
define('PUBLIC_TRANSPORT_TO_APARTMENTS', 'The following vechiles stop in front of, behind or under the building<br>- Bus 7, 78, 8, 112, 15, 5, City Bus<br>- Subway blue line<br>- Tram 2<br>- Several Night bus lines');
...
define('THANKS_FOR_CONTACTING', 'Thank you for the inquiry.');
...
define('WATCH_INTRO_VIDEO', 'Our video');
