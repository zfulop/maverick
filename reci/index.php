...
<h2 style="margin-top: 60px;"><a class="next_month_btn" href="index.php?year=$previousMonthYear&month=$previousMonthMonth" title="Previous month">&lt;</a> Room availability for: $selectedYear/$selectedMonth <a class="next_month_btn" href="index.php?year=$nextMonthYear&month=$nextMonthMonth" title="Next month">&gt;</a></h2>
