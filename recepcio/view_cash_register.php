...
list($payments, $cashOuts, $gtransfers, $eurCasse, $hufCasse, $eurCasse2, $hufCasse2) = loadCashRegisterData($viewDay, $lastDayCloseTime, $dayCloseEur, $dayCloseHuf, $dayCloseHuf2, $dayCloseEur2, $link);
