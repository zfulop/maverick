...
$name = mysql_real_escape_string($_REQUEST['title_eng']);
$description = mysql_real_escape_string($_REQUEST['description_eng']);
...
function saveLangText($paramName,$lang, $id, $link) {
	$value = mysql_real_escape_string($_REQUEST[$paramName . '_' . $lang]);
