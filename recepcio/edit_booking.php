...
<a href="#" onclick="if(confirm('Are you sure to change the booking to no show?')) { window.location='cancel_booking.php?description_id=$descrId&type=no_show';} return false;">No show</a><br>
<form>
