...
$bcrTo = array();
$sendBcr = array();
$sql = "SELECT * FROM booking_descriptions WHERE first_night<='$oneWeekFromToday' AND cancelled=0 AND confirmed=0 AND checked_in=0 AND bcr_sent IS NULL ORDER BY first_night";
