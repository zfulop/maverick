...
$sql = "SELECT * FROM mending_list ORDER BY create_date";
...
while($row = mysql_fetch_assoc($result)) {
	...
	echo <<<EOT
	<tr id="tr_view_$id"><td>$cdate</td><td>$descr</td><td><a href="delete_mending_item.php?id=$id">Delete</a> <a href="#" onclick="$('tr_view_$id').hide();$('tr_edit_$id').show();">Edit</a></td></tr>
