...
$sql = "SELECT name,telephone,email,nationality,source,first_night as arrival_date, '$today' as departure_date FROM booking_descriptions WHERE last_night='$today'";
